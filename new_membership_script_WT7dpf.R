## List of prefixes
#prefix<-"180220_WT_h2b_gc6s_7dpf_f1"
prefix<-"180220_WT_h2b_gc6s_7dpf_f2"
#prefix<-"180220_WT_h2b_gc6s_7dpf_f3"
#prefix<-"180323_WT_h2b_gc6s_7dpf_f1"
#prefix<-"180503_WT_h2b_gc6s_7dpf_f1"
#prefix<-"180510_WT_h2b_gc6s_7dpf_f1"
#prefix<-"180510_WT_h2b_gc6s_7dpf_f2"
#prefix<-"180510_WT_h2b_gc6s_7dpf_f3"
...
loadS=T
if(loadS) s<-read.table(paste("/Users/MeyerLab/SeG/results/Baysian_network_inference/data_for_Gibbs/7_dpf/", prefix, "_sa_aligned_all_cells_spikes.dat",sep=""));

# load results
mem_traj<-read.table(paste(folder,"/membership_traj.dat",sep=""))
centers<-read.table(paste("/Users/MeyerLab/SeG/results/Baysian_network_inference/data_for_Gibbs/7_dpf/",prefix,"_sa_aligned_all_cells_centers_cut_ordered.dat",sep=""));
#centers[,1:2]<-read.table(paste("~/SeG/results/Baysian_network_inference/Grav_7_dpf/",prefix,"_registered_cell_centers.dat",sep=""));
...
find_midline <- function(){
  ...
  manipulate(plot_points(centers [,1:2], a, b), a =slider(210,600), b = slider(-3,-0.5))
}
...
raster_plot <- function(stmp1) {
  ...
  par(mar = c(3,3,2,1))
  plot(u1[stmp1_vec>0],v1[stmp1_vec>0],pch=19,cex=0.0001,col="black",axes =F, xaxs = "i", yaxs ="i")
  plot(colSums(stmp1), type ="h", axes=T, xaxs = "i", yaxs ="i", ylim = c(0,100))
